...
{{< column >}}
<br>
{{< button href="" >}}Launch Slack{{< /button >}}(https://f3greenlevel.slack.com)
{{< endcolumns >}}
...
> **Tip**: The F3 Carpex Slack (where Green Level started) has been around longer, so has a lot more people and channels. For an invite to Green Level slack, search "slack" on this [F3 Green Level page](https://f3greenlevel.slack.com)
| Channel                  | Description                                                                                                                          |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ |
